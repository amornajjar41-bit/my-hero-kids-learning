...
const REASONS: { icon: string; en: string; ar: string; sub_en: string; sub_ar: string }[] = [
  ...
  },
  {
    ...
    ar: "يغطي كل المواد",
    sub_en: "Math, English, Arabic, Science — one app for everything",
    sub_ar: "رياضيات، إنجليزي، عربي، علوم — تطبيق واحد لكل شيء",
  },
  {
    icon: "🌍",
    en: "Fully Bilingual",
    ar: "ثنائي اللغة بالكامل",
    sub_en: "English and Arabic in every lesson, every day",
    sub_ar: "إنجليزي وعربي في كل درس وكل يوم",
  },
  {
    icon: "👶",
