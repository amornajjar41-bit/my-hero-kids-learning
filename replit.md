...
- **4C – First-Time Tour**: `components/Tour.tsx` — 5-step interactive modal overlay using API TTS (echo/nova voice — no expo-speech). Shows once after registration. Steps: Homework Helper, Games, English Lessons, Bedtime Stories, Rewards. Ends with confetti.
